...
describe('DocumentToHTML', function() {
  it("should render document nearly accurately", function() {
    this.loadDocument("/test/fixtures/documents/testdoc1.html", function(doc) {
      expect(snapdoc.document(doc)).toBe([
